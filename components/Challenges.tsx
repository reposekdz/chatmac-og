...
const challengeData: Challenge[] = [
    { id: 1, title: 'Golden Hour Photo', description: 'Share your best sunset or sunrise picture.', participants: 12500, icon: ' ImageIcon' },
    { id: 2, title: 'Two-Sentence Story', description: 'Write a compelling story in just two sentences.', participants: 8300, icon: 'ChatBubbleIcon' },
    { id: 3, title: '#CreativeCollab', description: 'Find a partner and create a joint post!', participants: 540, icon: 'ShareIcon' },
    { id: 4, title: 'My Retro Setup', description: 'Show off your best vintage tech or gaming setup.', participants: 2100, icon: 'ShareIcon' },
]
      ...
      <div className="flex flex-col space-y-4">
        {challengeData.map(challenge => (
            <div key={challenge.id} className="bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-xl p-4 flex items-center justify-between">
                ...
                <button className="bg-orange-500 text-white font-bold py-2 px-4 rounded-full text-sm hover:bg-orange-600 transition-colors retro-button">
                    Join
                </button>
            </div>
        ))}
